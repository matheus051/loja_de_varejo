    ...
    <main class="mt-4 ml-4">
        <form action="../controller/Product.php" method="POST">
            <section class="columns-3">
                ...
                <article>
                    <label for="price">Digite o CNPJ: </label>
                    <input type="text" id="price" name="price" class="border border-blue-400" min=1 max=14>
                </article>
                <article>
                    <label for="quantity">Telefone do fornecedor: </label>
                    <input type="text" id="quantity" name="quantity" class="border border-blue-400" min=1 max=100>
                </article>
            </section>
